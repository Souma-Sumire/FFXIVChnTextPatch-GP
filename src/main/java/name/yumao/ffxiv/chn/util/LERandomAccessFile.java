...
public final class LERandomAccessFile implements DataInput, DataOutput {
	...
	public final long readLong() throws IOException {
		...
		return (this.work[7] << 56 | (this.work[6] & 0xFF) << 48 | (this.work[5] & 0xFF) << 40
				| (this.work[4] & 0xFF) << 32 | (this.work[3] & 0xFF) << 24 | (this.work[2] & 0xFF) << 16
				| (this.work[1] & 0xFF) << 8 | this.work[0] & 0xFF);
	}
